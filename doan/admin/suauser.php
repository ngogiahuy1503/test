...
<div id="container_ad">
	...
	<div id="content_ad">
	  <table width="900" border="1" cellpadding="0">
	    <tr>
	      <th colspan="2" scope="col">Quản lý thành viên</th>
        </tr>
	    <tr>
	      ...
	      <td><form id="form1" name="form1" method="post" action="">
	        <p>
	          <label>
	            <input type="radio" name="phanquyen" value="0" id="phanquyen_0" />
	            User</label>
	          <br />
	          <label>
	            <input type="radio" name="phanquyen" value="1" id="phanquyen_1" />
	            Admin</label>
	          <br />
            </p>
          </form></td>
